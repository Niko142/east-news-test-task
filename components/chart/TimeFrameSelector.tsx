    ...
    <menu className="flex gap-2">
      {TIMEFRAMES.map((tmf) => (
        <button
          key={tmf}
          className={clsx(
            "rounded-md px-3 py-1 text-xs font-semibold outline-offset-2 transition-colors duration-400 focus-visible:outline-2 focus-visible:outline-gray-700 md:text-sm",
